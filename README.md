...
#### Example Pull Reports 1.3.0 local Maven Repository

This is what your local maven repository directory structure should look like assuming you have version `1.3.0` of Pull Reports.

    $ ls -1 ~/.m2/repository/com/pullreports/pullreports/1.3.0
    pullreports-1.3.0.jar
    pullreports-1.3.0.pom
