...
<body>
    <div class='container'>
	    <div class='page-header'><h1>Pet Store JEE Demonstration</h1></div> 
        ...
        <p>Navigate to the <a href='${pageContext.request.contextPath}/adHocCreator'>Ad Hoc Creator</a> page to see an example installation
